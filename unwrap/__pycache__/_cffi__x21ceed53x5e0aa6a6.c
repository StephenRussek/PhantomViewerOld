...
static PyObject *
_cffi_f_unwrap3D(PyObject *self, PyObject *args)
{
  float * x0;
  float * x1;
  unsigned char * x2;
  ...
  if (!PyArg_ParseTuple(args, "OOOOOOOOO:unwrap3D", &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  _cffi_restore_errno();
  { unwrap3D(x0, x1, x2, x3, x4, x5, x6, x7, x8); }
  _cffi_save_errno();
...
static PyMethodDef _cffi_methods[] = {
  {"unwrap3D", _cffi_f_unwrap3D, METH_VARARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x21ceed53x5e0aa6a6(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x21ceed53x5e0aa6a6(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x21ceed53x5e0aa6a6", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
