...
static PyMethodDef _cffi_methods[] = {
  {"unwrap2D", _cffi_f_unwrap2D, METH_VARARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x7c0fa711xfa0d59b3(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x7c0fa711xfa0d59b3(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x7c0fa711xfa0d59b3", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
