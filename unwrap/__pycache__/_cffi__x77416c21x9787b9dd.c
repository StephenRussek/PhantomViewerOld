...
PyMODINIT_FUNC
PyInit__cffi__x77416c21x9787b9dd(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x77416c21x9787b9dd(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x77416c21x9787b9dd", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
