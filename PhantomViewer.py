...
Uses PhantomViewerGui created from PhantomVIewerGui.ui by QT4
  execute   "pyuic4 PhantomViewerGui.ui -o PhantomViewerGui.py"
"""

import sys
from PyQt4 import QtGui, QtCore
from PhantomViewerGui import Ui_PhantomViewerMainWindow
import ROIView
try:
  import Recon
except:
...
class MainDialog(QtGui.QMainWindow):
    ...
    def Geometry(self): # opens ROIView module with Geometry labels
        self.GeometryView = ROIView.ROIView(self)
    ...
    def ResolutionInset(self):
        self.ResInset = ROIView.ROIView(self, "Proton Density")
    ...
    def Dicom(self):
        self.DicomConvert = ROIView.ROIView(self, "Proton Density")
